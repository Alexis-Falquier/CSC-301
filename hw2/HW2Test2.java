...
public class HW2Test2 {
	...
	*/
	...
	public void test20TreeEquals() {
		...
		s1 = MyIntSET.fromString("50 150 100");
		s2 = MyIntSET.fromString("50 100 150");
		assertFalse(s1.treeEquals(s2));
		assertFalse(s2.treeEquals(s1));
	}
	...
	public void test10IsPerfectlyBalancedS() {
		...
		set = MyIntSET.fromString("100");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("100 50");
		assertFalse(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("100 50 150");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("100 150 50");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("150 50 100");
		assertFalse(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 100 150");
		assertFalse(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 25 75 12 37 62 87");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 25 12 37 75 62 87");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 75 62 87 25 12 37");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 25 75 12 37 62 87 51");
		assertFalse(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 25 75 12 22 62 87");
		assertFalse(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 25 75 12 37 62 87 5 18 31 42 56 68 81 93");
		assertTrue(set.isPerfectlyBalancedS());
		set = MyIntSET.fromString("50 25 75 12 37 62 87 5 18 31 36 56 68 81 93");
		assertFalse(set.isPerfectlyBalancedS());
	}
	...
	public void test10RemoveOddSubtrees() {
		...
		set = MyIntSET.fromString("101");
		set.removeOddSubtrees();
		assertEquals("", set.toString());
		set = MyIntSET.fromString("100 98 101");
		set.removeOddSubtrees();
		assertEquals("100 98 ", set.toString());
		set = MyIntSET.fromString("100 91 102");
		set.removeOddSubtrees();
		assertEquals("100 102 ", set.toString());
		set = MyIntSET.fromString("101 98 100");
		set.removeOddSubtrees();
		assertEquals("", set.toString());
		set = MyIntSET.fromString("100 50 150 20 60 130 180");
		set.removeOddSubtrees();
		assertEquals("100 50 150 20 60 130 180 ", set.toString());
		set = MyIntSET.fromString("100 50 150 20 61 130 180");
		set.removeOddSubtrees();
		assertEquals("100 50 150 20 130 180 ", set.toString());
		set = MyIntSET.fromString("100 50 150 20 60 130 181");
		set.removeOddSubtrees();
		assertEquals("100 50 150 20 60 130 ", set.toString());
		set = MyIntSET.fromString("100 50 150 21 60 131 180");
		set.removeOddSubtrees();
		assertEquals("100 50 150 60 180 ", set.toString());
		set = MyIntSET.fromString("100 51 150 20 60 130 180");
		set.removeOddSubtrees();
		assertEquals("100 150 130 180 ", set.toString());
		set = MyIntSET.fromString("100 50 151 20 60 130 180");
		set.removeOddSubtrees();
		assertEquals("100 50 20 60 ", set.toString());
		set = MyIntSET.fromString("100 57 153 20 60 130 180");
		set.removeOddSubtrees();
		assertEquals("100 ", set.toString());
		set = MyIntSET.fromString("97 50 150 20 60 130 180");
		set.removeOddSubtrees();
		assertEquals("", set.toString());
		set = MyIntSET.fromString("99 51 153 25 59 131 189");
		set.removeOddSubtrees();
		assertEquals("", set.toString());
	}
